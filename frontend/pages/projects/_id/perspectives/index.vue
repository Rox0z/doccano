...
export default Vue.extend({
  ...
  methods: {
    ...
    async submitAnswers(formattedAnswers: { questionId: number; answer: string; questionType: number }[]) {
      console.log('Respostas submetidas (index.vue):', formattedAnswers)
      console.log('Project ID recebido (index.vue) - (no longer passed as arg, using this.projectId):', this.projectId)
      try {
